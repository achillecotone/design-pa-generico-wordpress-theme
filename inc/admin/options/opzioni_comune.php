...
function dci_register_comune_options()
{
    ...
    $args = array(
        ...
        'tab_title' => __('Generale', "design_comuni_italia"),
    ...
    $header_options->add_field(array(
        ...
        'name' => __('Configurazione PA', 'design_comuni_italia'),
    ...
    $header_options->add_field(array(
        ...
        'name' => __('Nome della PA *', 'design_comuni_italia'),
        'desc' => __('Il Nome della PA', 'design_comuni_italia'),
        'type' => 'text',
        'attributes' => array(
            'required' => 'required'
        ),
    ...
    $header_options->add_field(array(
        ...
        'name' => __('Motto ', 'design_comuni_italia'),
        'desc' => __('Il Motto della PA, viene visualizzato sotto il nome della PA', 'design_comuni_italia'),
        'type' => 'text',
    ));
