...
function dci_register_pagina_vivi_options()
{
    ...
    $args = array(
        ...
        'option_key' => 'vivi',
        'tab_title' => __('Eventi della PA', "design_comuni_italia"),
    ...
    $vivi_options->add_field(array(
        ...
        'name' => __('Eventi della Pubblica Amministrazione', 'design_comuni_italia'),
        'desc' => __('Configurazione della pagina eventi della PA', 'design_comuni_italia'),
        'type' => 'title',
    ));
    $vivi_options->add_field(array(
        'id' => $prefix . 'immagine',
