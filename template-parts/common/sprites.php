<div class="svg-vault d-none">
    <svg xmlns="http://www.w3.org/2000/svg">
        ...
        <symbol id="it-arrow-down-triangle" viewBox="0 0 24 24"><path d="M9.2 12h5.6c.6 0 1 .5 1 1 0 .3-.1.5-.3.7L12 17.3l-3.5-3.6c-.4-.4-.4-1 0-1.4.2-.2.4-.3.7-.3z" /></symbol>
        <symbol id="it-arrow-down" viewBox="0 0 24 24"><path d="M17.9 13.2l-5.4 5.3V3h-1v15.5l-5.4-5.3-.7.7 6.6 6.5 6.6-6.5-.7-.7z" /></symbol>
        ...
        <symbol id="it-arrow-left-triangle" viewBox="0 0 24 24"><path d="M12 9.2v5.6c0 .6-.5 1-1 1-.3 0-.5-.1-.7-.3L6.8 12l3.5-3.5c.4-.4 1-.4 1.4 0 .2.2.3.4.3.7z" /></symbol>
        ...
        <symbol id="it-arrow-left" viewBox="0 0 24 24"><path d="M21 11.5H5.5l5.3-5.4-.7-.7L3.6 12l6.5 6.6.7-.7-5.3-5.4H21v-1z" /></symbol>
        <symbol id="it-arrow-right-triangle" viewBox="0 0 24 24"><path d="M12 14.8V9.2c0-.6.5-1 1-1 .3 0 .5.1.7.3l3.5 3.5-3.5 3.5c-.4.4-1 .4-1.4 0-.2-.2-.3-.4-.3-.7z" /></symbol>
        <symbol id="it-arrow-right" viewBox="0 0 24 24"><path d="M13.9 5.4l-.7.7 5.3 5.4H3v1h15.5l-5.3 5.4.7.7 6.6-6.6-6.6-6.6z" /></symbol>
        ...
        <symbol id="it-arrow-up-triangle" viewBox="0 0 24 24"><path d="M14.8 12H9.2c-.6 0-1-.5-1-1 0-.3.1-.5.3-.7L12 6.8l3.5 3.5c.4.4.4 1 0 1.4-.2.2-.4.3-.7.3z" /></symbol>
        <symbol id="it-arrow-up" viewBox="0 0 24 24"><path d="M18.6 10.1L12 3.5l-6.6 6.6.7.7 5.4-5.3V21h1V5.5l5.4 5.3.7-.7z" /></symbol>
        ...
        <symbol id="it-bookmark" viewBox="0 0 24 24"><path d="M18 22.7l-6-6-6 6V2h12v20.7zm-6-7.4l5 5V3H7v17.3l5-5z" /></symbol>
        <symbol id="it-box" viewBox="0 0 24 24">
            <path d="M21 2H3v4h1v16h16V6h1V2zm-2 19H5V6h14v15zm1-16H4V3h16v2z" />
            <path d="M8 8h8v1H8z" />
        </symbol>
        <symbol id="it-burger" viewBox="0 0 24 24"><path d="M22 5v1H2V5h20zM2 12.5h20v-1H2v1zM2 19h20v-1H2v1z" /></symbol>
        ...
        <symbol id="it-check-circle" viewBox="0 0 24 24"><path d="M17.1 7.9l.7.7-7.8 7.6-4.7-4.6.7-.7 4 3.9 7.1-6.9zM22 12c0 5.5-4.5 10-10 10S2 17.5 2 12 6.5 2 12 2s10 4.5 10 10zm-1 0c0-5-4-9-9-9s-9 4-9 9 4 9 9 9 9-4 9-9z" /></symbol>
        <symbol id="it-check" viewBox="0 0 24 24"><path d="M9.6 16.9L4 11.4l.8-.7 4.8 4.8 8.5-8.4.7.7-9.2 9.1z" /></symbol>
        <symbol id="it-chevron-left" viewBox="0 0 24 24"><path d="M14.6 17.2L9 11.6 14.6 6l.8.7-4.9 4.9 4.9 4.9z" /></symbol>
        <symbol id="it-chevron-right" viewBox="0 0 24 24"><path d="M9.8 17.2l-.8-.7 4.9-4.9L9 6.7l.8-.7 5.6 5.6z" /></symbol>
        ...
        <symbol id="it-clock" viewBox="0 0 24 24"><path d="M11.5 5h1v7.5H7v-1h4.5V5zM22 12c0 5.5-4.5 10-10 10S2 17.5 2 12 6.5 2 12 2s10 4.5 10 10zm-1 0c0-5-4-9-9-9s-9 4-9 9 4 9 9 9 9-4 9-9z" /></symbol>
        <symbol id="it-close-big" viewBox="0 0 24 24"><path d="M12.7 12l6.7 6.6-.8.8-6.6-6.7-6.6 6.7-.8-.8 6.7-6.6-6.7-6.6.8-.8 6.6 6.7 6.6-6.7.8.8-6.7 6.6z" /></symbol>
        ...
        <symbol id="it-close" viewBox="0 0 24 24"><path d="M12.7 12l3.7 3.6-.8.8-3.6-3.7-3.6 3.7-.8-.8 3.7-3.6-3.7-3.6.8-.8 3.6 3.7 3.6-3.7.8.8-3.7 3.6z" /></symbol>
        <symbol id="it-code-circle" viewBox="0 0 24 24">
            <path
                    d="M19 12l-2.9 2.9-.7-.8 2.1-2.1-2.1-2.1.7-.8L19 12zM7.9 9.1L5 12l2.9 2.9.7-.8L6.5 12l2.1-2.1-.7-.8zM22 12c0 5.5-4.5 10-10 10S2 17.5 2 12 6.5 2 12 2s10 4.5 10 10zm-1 0c0-5-4-9-9-9s-9 4-9 9 4 9 9 9 9-4 9-9zM9.6 16.5l1 .3 3.7-9.3-.9-.3-3.8 9.3z"
            />
        </symbol>
        <symbol id="it-collapse" viewBox="0 0 24 24"><path d="M16.5 15.4l-4.9-4.9-4.9 4.9-.7-.8L11.6 9l5.6 5.6z" /></symbol>
        ...
        <symbol id="it-download" viewBox="0 0 24 24"><path d="M12 14.2L7.7 9.9l.7-.7 3.1 3.1V3h1v9.2l3.1-3 .7.7-4.3 4.3zm7-2.2v7.5c0 .3-.2.5-.5.5h-13c-.3 0-.5-.2-.5-.5V12H4v7.5c0 .8.7 1.5 1.5 1.5h13c.8 0 1.5-.7 1.5-1.5V12h-1z" /></symbol>
        <symbol id="it-error" viewBox="0 0 24 24"><path d="M11.5 14.2V5.7h1.2v8.5h-1.2zm-.1 4.1h1.2v-1.8h-1.2v1.8zM22 7.9v8.3L16.1 22H7.9L2 16.2V7.9L7.9 2h8.2L22 7.9zm-1 .4L15.7 3H8.3L3 8.3v7.5L8.3 21h7.4l5.3-5.2V8.3z" /></symbol>
        <symbol id="it-exchange-circle" viewBox="0 0 24 24">
            <path
                    d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 19c-5 0-9-4-9-9s4-9 9-9 9 4 9 9-4 9-9 9zm5.1-8.9l.8.8-4.3 4.3c-.3.3-.7.4-1.1.4-.4 0-.8-.1-1.1-.4L9 14.7V17H8v-4h4v1H9.7l2.4 2.5h.8l4.2-4.4zm-6-4.6l-4.2 4.4-.8-.8 4.3-4.3c.3-.3.7-.4 1.1-.4.4 0 .8.1 1.1.4L15 9.3V7h1v4h-4v-1h2.3l-2.4-2.5h-.8z"
            />
        </symbol>
        <symbol id="it-expand" viewBox="0 0 24 24"><path d="M11.6 15.4L6 9.8l.7-.8 4.9 4.9L16.5 9l.7.8z" /></symbol>
        ...
        <symbol id="it-facebook-square" viewBox="0 0 24 24">
            <path
                    d="M17 0H1C.4 0 0 .4 0 1v16c0 .6.4 1 1 1h8.6v-6.9H7.3V8.3h2.3v-2c-.1-1 .2-1.9.9-2.6s1.6-1.1 2.6-1c.7 0 1.4 0 2.1.1v2.4h-1.4c-1.1 0-1.3.5-1.3 1.3v1.7h2.7l-.4 2.7h-2.3v7H17c.6 0 1-.4 1-1V1c0-.6-.4-1-1-1z"
                    transform="translate(3 3)"
            />
        </symbol>
        <symbol id="it-facebook" viewBox="0 0 24 24"><path d="M13.6 22v-9.1h3.1l.5-3.6h-3.5V7.1c0-1 .3-1.7 1.8-1.7h1.9V2.1c-1.1-.1-2-.1-3-.1-2.7 0-4.6 1.7-4.6 4.7v2.6h-3v3.6h3.1V22h3.7z" /></symbol>
        ...
        <symbol id="it-flag" viewBox="0 0 24 24"><path d="M17.1 8l3.3-5H5V2H4v20h1v-9h15.4l-3.3-5zM5 4h13.6l-2.7 4 2.7 4H5V4z" /></symbol>
        ...
        <symbol id="it-fullscreen" viewBox="0 0 24 24"><path d="M4 20h4.5v1H3v-5.5h1zM3 8.5h1V4h4.5V3H3zM20 20h-4.5v1H21v-5.5h-1zM15.5 3v1H20v4.5h1V3z" /></symbol>
        <symbol id="it-funnel" viewBox="0 0 24 24"><path d="M14 22h-1v-8.6L20 3H4l7 10.4V22h-1v-8.4L2 2h20l-8 11.6V22z" /></symbol>
        ...
        <symbol id="it-horn" viewBox="0 0 24 24">
            <path
                    d="M5 9c-1.7 0-3 1.3-3 3s1.3 3 3 3h.5L7 19.3c.3 1 1.3 1.7 2.3 1.7h.2c.5 0 .9-.2 1.2-.6.3-.4.4-.9.2-1.4l-1.3-4h1.8l8.6 3.8V4.7L11.4 9H5zm5 10.3c0 .2 0 .4-.1.5l-.4.2h-.2c-.6 0-1.2-.4-1.4-1l-1.3-4h1.9l1.5 4.3zM5 14c-1.1 0-2-.9-2-2s.9-2 2-2h6v4H5zm14 3.2l-7-3V9.8l7-3.5v10.9zM22 9v6h-1V9h1z"
            />
        </symbol>
        ...
        <symbol id="it-info-circle" viewBox="0 0 24 24"><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 19c-5 0-9-4-9-9s4-9 9-9 9 4 9 9-4 9-9 9zm-.7-15h1.5v2h-1.5V6zm0 3h1.5v9h-1.5V9z" /></symbol>
        ...
        <symbol id="it-mail" viewBox="0 0 24 24">
            <path
                    d="M20.5 5h-17C2.7 5 2 5.7 2 6.5v11c0 .8.7 1.5 1.5 1.5h17c.8 0 1.5-.7 1.5-1.5v-11c0-.8-.7-1.5-1.5-1.5zm-.3 1l-7.1 7.2c-.6.6-1.6.6-2.2 0L3.8 6h16.4zM3 17.3V6.6L8.3 12 3 17.3zm.7.7L9 12.7l1.2 1.2c1 .9 2.6.9 3.6 0l1.2-1.2 5.3 5.3H3.7zm12-6L21 6.6v10.7L15.7 12z"
            />
        </symbol>
        ...
        <symbol id="it-medium-square" viewBox="0 0 24 24">
            <path
                    d="M3 3h18v18H3V3zm4.3 11.4c0 .2 0 .4-.2.5l-1.3 1.5v.2h3.6v-.2l-1.3-1.5c-.1-.1-.1-.3-.1-.5V9.7l3.2 6.9h.4l2.7-6.9v5.5c0 .2 0 .2-.1.3l-1 1v.2h4.7v-.2l-.9-1c-.1-.1-.1-.2-.1-.3V8.5c0-.1 0-.2.1-.3l1-.9v-.2h-3.4L12.2 13 9.5 7.1H6v.2l1.1 1.4c.1 0 .2.2.2.3v5.4z"
            />
        </symbol>
        <symbol id="it-medium" viewBox="0 0 24 24">
            <path
                    d="M5 7.6c0-.2 0-.4-.2-.6L3.1 5v-.3h5.2l4 8.8 3.5-8.8h5V5l-1.4 1.4c-.1.1-.2.2-.2.4v10.1c0 .2 0 .3.2.4l1.4 1.4v.3h-7v-.3l1.4-1.4c.1-.1.1-.2.1-.4V8.7L11.4 19h-.6L6.1 8.7v6.9c0 .3.1.6.3.8l1.9 2.3v.3H2.9v-.3l1.9-2.3c.2-.2.3-.5.2-.8v-8z"
            />
        </symbol>
        <symbol id="it-minimize" viewBox="0 0 24 24"><path d="M3 15.5h5.5V21h-1v-4.5H3zM7.5 7.5H3v1h5.5V3h-1zM15.5 21h1v-4.5H21v-1h-5.5zM16.5 7.5V3h-1v5.5H21v-1z" /></symbol>
        <symbol id="it-minus" viewBox="0 0 24 24"><path d="M20 12.5H4v-1h16v1z" /></symbol>
        <symbol id="it-minus-circle" viewBox="0 0 24 24"><path d="M6.9 11.5h10v1h-10v-1zM22 12c0 5.5-4.5 10-10 10S2 17.5 2 12 6.5 2 12 2s10 4.5 10 10zm-1 0c0-5-4-9-9-9s-9 4-9 9 4 9 9 9 9-4 9-9z" /></symbol>
        ...
        <symbol id="it-note" viewBox="0 0 24 24">
            <path
                    d="M18.5 4h-13C4.7 4 4 4.7 4 5.5v13c0 .8.7 1.5 1.5 1.5h10.2l4.3-4.3V5.5c0-.8-.7-1.5-1.5-1.5zM5 18.5v-13c0-.3.2-.5.5-.5h13c.3 0 .5.2.5.5V15h-2.5c-.8 0-1.5.7-1.5 1.5V19H5.5c-.3 0-.5-.2-.5-.5zM18.3 16L16 18.3v-1.8c0-.3.2-.5.5-.5h1.8zM16 9H8V8h8v1zm0 2H8v-1h8v1zm-2 1v1H8v-1h6z"
            />
        </symbol>
        <symbol id="it-open-source" viewBox="0 0 24 24">
            <path
                    d="M10 0C4.5 0 0 4.5 0 10c0 4.3 2.7 8.1 6.8 9.5l1.7-5.8.3-1C7.7 12.3 7 11.2 7 10c0-1.7 1.3-3 3-3s3 1.3 3 3c0 1.2-.7 2.3-1.9 2.8l.3 1 1.8 5.8c5.3-1.7 8.1-7.3 6.4-12.6-1.3-4.2-5.2-7-9.6-7zm3.8 18.1l-1.5-4.9c.1-.1.2-.1.2-.2.1-.1.2-.1.2-.2l.2-.2c.3-.3.6-.7.7-1.1l.1-.3c0-.1.1-.2.1-.3 0-.2.1-.3.1-.5V10c0-2.2-1.8-4-4-4s-4 1.8-4 4v.5c0 .2.1.3.1.4 0 .2.1.3.1.4.1.3.3.6.4.8.1.1.2.3.3.4l.3.3c.1.1.2.2.4.3L6 18C1.5 15.9-.4 10.5 1.7 6s7.5-6.4 12-4.3 6.4 7.5 4.3 12c-.7 2-2.3 3.6-4.2 4.4z"
                    transform="translate(2 2)"
            />
        </symbol>
        <symbol id="it-pa" viewBox="0 0 24 24"><path d="M3 21h18v1H3v-1zm0-1h18v-1H3v1zM22 9H2l10-7 10 7zM5.2 8h13.6L12 3.2 5.2 8zM6 18v-8H5v8h1zm4 0v-8H9v8h1zm5 0v-8h-1v8h1zm4 0v-8h-1v8h1z" /></symbol>
        ...
        <symbol id="it-pin" viewBox="0 0 24 24"><path d="M18.1 14L15 10.3V4.6L16.3 2H7.7L9 4.6v5.7L5.9 14h5.6v8h1v-8h5.6zM10 5h4v5h-4V5zm4.7-2l-.5 1H9.8l-.5-1h5.4zm-5 8h4.6l1.6 2H8.1l1.6-2z" /></symbol>
        ...
        <symbol id="it-plus-circle" viewBox="0 0 24 24"><path d="M12.4 11.5h4.5v1h-4.5V17h-1v-4.5H6.9v-1h4.5V7h1v4.5zm9.6.5c0 5.5-4.5 10-10 10S2 17.5 2 12 6.5 2 12 2s10 4.5 10 10zm-1 0c0-5-4-9-9-9s-9 4-9 9 4 9 9 9 9-4 9-9z" /></symbol>
        <symbol id="it-plus" viewBox="0 0 24 24"><path d="M20 12.5h-7.5V20h-1v-7.5H4v-1h7.5V4h1v7.5H20v1z" /></symbol>
        ...
        <symbol id="it-rss-square" viewBox="0 0 24 24">
            <path
                    d="M14.6 0H3.4C1.5 0 0 1.5 0 3.4v11.2C0 16.5 1.5 18 3.4 18h11.3c1.9 0 3.4-1.5 3.4-3.4V3.4C18 1.5 16.5 0 14.6 0zM4.5 15.8c-1.2 0-2.3-1-2.3-2.3s1-2.3 2.3-2.3 2.3 1 2.3 2.3-1.1 2.3-2.3 2.3zm4.5 0C9 12 6 9 2.3 9V6.8c5 0 9 4 9 9H9zm4.5 0c0-6.2-5-11.3-11.3-11.3V2.3c7.5 0 13.5 6 13.5 13.5h-2.2z"
                    transform="translate(3 3)"
            />
        </symbol>
        ...
        <symbol id="it-search" viewBox="0 0 24 24"><path d="M21.9 21.1L16 15.3c1.3-1.5 2-3.4 2-5.3 0-4.4-3.6-8-8-8s-8 3.6-8 8 3.6 8 8 8c1.9 0 3.8-.7 5.3-2l5.8 5.9.8-.8zM10 17c-3.9 0-7-3.1-7-7s3.1-7 7-7 7 3.1 7 7-3.1 7-7 7z" /></symbol>
        ...
        <symbol id="it-star-full" viewBox="0 0 24 24"><path d="M12 1.7L9.5 9.2H1.6L8 13.9l-2.4 7.6 6.4-4.7 6.4 4.7-2.4-7.6 6.4-4.7h-7.9L12 1.7z" /></symbol>
        ...
        <symbol id="it-twitter-x" viewBox="0 0 24 24">
        ...
        <symbol id="it-upload" viewBox="0 0 24 24"><path d="M8.4 7.3l-.7-.7L12 2.3l4.3 4.3-.7.7-3.1-3.1v9.3h-1V4.2L8.4 7.3zM19 12v7.5c0 .3-.2.5-.5.5h-13c-.3 0-.5-.2-.5-.5V12H4v7.5c0 .8.7 1.5 1.5 1.5h13c.8 0 1.5-.7 1.5-1.5V12h-1z" /></symbol>
        ...
        <symbol id="it-video" viewBox="0 0 24 24">
            <path
                    d="M17.5 7.3V6c0-.8-.7-1.5-1.5-1.5H5.5C4.7 4.5 4 5.2 4 6v8c0 .8.7 1.5 1.5 1.5h3.4L7.4 21h1l1.6-5.5h1.8l1.6 5.5h1l-1.6-5.5H16c.8 0 1.5-.7 1.5-1.5v-1.3l4 1.5V5.8l-4 1.5zm3 5.5l-4-1.5V14c0 .3-.2.5-.5.5H5.5c-.3 0-.5-.2-.5-.5V6c0-.3.2-.5.5-.5H16c.3 0 .5.2.5.5v2.7l4-1.5v5.6zM2 8h1v4H2V8z"
            />
        </symbol>
        <symbol id="it-warning-circle" viewBox="0 0 24 24"><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 19c-5 0-9-4-9-9s4-9 9-9 9 4 9 9-4 9-9 9zm-.5-6.8V5.7h1.2v8.5h-1.2zm-.1 2.3h1.2v1.8h-1.2v-1.8z" /></symbol>
        <symbol id="it-warning" viewBox="0 0 24 24"><path d="M12.5 17h-1V2h1v15zm0 3h-1v2h1v-2z" /></symbol>
