...
<header <?php body_class(); ?>>
    ...
    <?php get_template_part("template-parts/common/custom_style"); ?>
    <?php
    if (dci_get_option_tema("active_sticky") == 'true'){
    ?>
                                            ...
                                            <div class="it-socials d-none d-lg-flex">
                                                ...
                                                <ul>
                                                    <?php foreach ($socials as $social) { ?>
                                                        <li>
                                                            <a href="<?php echo $social['url_social'] ?>"
                                                               target="_blank">
                                                                <svg class="icon">
                                                                    <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                         href="#<?php echo $social['icona_social'] ?>"></use>
                                                                </svg>
                                ...
                                <div class="navbar navbar-expand-lg has-megamenu">
                                    ...
                                    <div class="navbar-collapsable" id="nav4">
                                        ...
                                        <div class="menu-wrapper">
                                            <a href="<?php echo home_url(); ?>" aria-label="Vai alla homepage"
